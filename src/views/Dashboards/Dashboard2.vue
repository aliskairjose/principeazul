        ...
        <iq-card>
          <template v-slot:body>
            ...
            <div class="iq-progress-bar-linear d-inline-block w-100  mt-5">
              <b-progress :value="80" class="iq-progress-bar" variant="danger" />
            </div>
          </template>
        </iq-card>
      </b-col>
      <div class="col-md-6 col-lg-3">
        <div class="iq-card">
          <div class="iq-card-body">
            ...
            <div class="iq-progress-bar-linear d-inline-block w-100  mt-5">
              <b-progress :value="80" class="iq-progress-bar" variant="info" />
            </div>
          </div>
        </div>
      </div>
      ...
      <div class="col-md-6 col-lg-3">
        <div class="iq-card">
          <div class="iq-card-body">
            ...
            <div class="iq-progress-bar-linear d-inline-block w-100  mt-5">
              <b-progress :value="80" class="iq-progress-bar" variant="bg-primary" />
            </div>
    ...
    <b-row>
          ...
          <template v-slot:body>
            <b-table responsive :items="items" class="mb-0 table-borderless">
              ...
              <template v-slot:cell(progress)="data1">
                <b-progress :value="data1.value.count" class="iq-progress-bar" :variant="data1.value.color">
                </b-progress>
              </template>
            </b-table>
          </template>
      ...
      <b-col lg="4">
        <iq-card>
          ...
          <template v-slot:body>
            <p class="mb-0">{{ $t('dashboard1.totalLikeComment')}}</p>
            ...
            <Slick id="post-slider">
              <li class="d-flex align-items-center">
                ...
                <div class="post-content pl-3">
                  ...
                  <b-progress :value="90" class="iq-progress-bar mb-3" variant="primary" />
