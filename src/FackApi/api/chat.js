...
export const MessagesUser1 = [
  ...
  new Message({ text: 'Absolutely!\n' + 'Vito Dashboard is the responsive bootstrap 4 admin template.', userId: 5, me: true, time: '6:50' }),
  ...
  new Message({ text: 'Absolutely!\n' + 'Vito Dashboard is the responsive bootstrap 4 admin template.', userId: 5, me: true, time: '7:10' }),
